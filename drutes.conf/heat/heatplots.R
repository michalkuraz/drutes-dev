...
ln_obs=read_data_plot('out/obspt_heat-','drutes-dev/out/obspt_heat-','.out',col1=1,col2=2,ylabs=expression(paste("temperature [°C]",sep=""))
                      ,xlabs="time [h]",'temp_point',skip=10,k=1,"topright")
if(ln_obs>0){
