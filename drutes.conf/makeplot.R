...
ln_obs=read_data_plot('out/obspt_RE_freeze_thaw-','drutes-dev/out/obspt_RE_freeze_thaw-'
                      ,'.out',col1=1,col2=6,ylabs=expression(paste("ice content [-]",sep=""))
...
ln_obs=read_data_plot('out/obspt_RE_freeze_thaw-','drutes-dev/out/obspt_RE_freeze_thaw-'
                      ,'.out',col1=1,col2=4,ylabs=expression(paste("liquid water content [-]",sep=""))
...
ln_obs=read_data_plot('out/obspt_RE_freeze_thaw-','drutes-dev/out/obspt_RE_freeze_thaw-'
                      ,'.out',col1=1,col2=5,ylabs=expression(paste("liquid pressure head [L]",sep=""))
